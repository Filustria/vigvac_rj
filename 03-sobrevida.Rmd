...
5. **Totalmente vacinado** - 14 dias após a segunda dose da vacina até data final da coorte (2021-11-27).
...
evento.pessoa.tempo %>%
  kbl(caption = "Incidência de casos de síndrome gripal dentre aqueles imunizados com AstraZeneca notificados de acordo com o Status vacinal do indivíduo no primeiro dia de sintomas. Estado do Rio de Janeiro, 2021") %>%
